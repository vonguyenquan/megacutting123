...
class EbayAdvanced extends AdvancedParser {
    ...
    {
        if ($this->xpathScalar(".//span[@class='msgTextAlign'][contains(.,'This listing has ended')]"))
            return false;

        if ($this->xpathScalar(".//span[@class='msgTextAlign'][contains(.,'This Buy It Now listing has ended')]"))
            return false;

        if ($this->xpathScalar(".//span[@class='msgTextAlign'][contains(.,'This item is out of stock')]"))
            return false;

        if ($this->xpathScalar(".//span[@class='msgTextAlign'][contains(.,'Bidding has ended on this item')]"))
            return false;
