...
class AutoimportTable extends MyListTable {
    ...
    function column_name($item)
    {
        ...
        $actions = array(
            ...
            'run' => sprintf('<a class="ei-run-autoimport" href="?page=external-importer-autoimport&action=run&id=%d">%s</a>', $item['id'], __('Run now', 'external-importer')),
            'delete' => sprintf('<a class="ei-autoimport-delete" href="?page=external-importer-autoimport&action=delete&id=%d">%s</a>', $item['id'], __('Delete', 'external-importer')),
        );
