...
class AdminNotice {
    ...
    {
        return array(
            'autoimport_saved' => __('Auto import has been saved successfully.', 'external-importer') . ' <a class="ei-run-autoimport" href="?page=external-importer-autoimport&action=run&id=%%ID%%">' . __('Run now', 'external-importer') . '</a>',
